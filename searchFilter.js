(function() {
  ...
  storage.local.get(['hideWikia'], (result) => {
    if (result && result.hideWikia) {
      ...
      const wikiaLinks = document.querySelectorAll('[href*="jojo.wikia.com"], [href*="jojo.fandom.com"]');
      ...
      function getParent(element, maxDepth = 10) {
        if (element.parentElement) {
          if (element.className === 'g') {
            ...
            removedElement.innerHTML="Fandom search result removed by JoJo Wiki Redirector."
